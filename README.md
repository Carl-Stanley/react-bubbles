...
- [x] Explain what a token is used for.
      A token is a unique id or code provided by a server when a user is logged in successfully. The token that then bes used to allow access to private pages hosted by the server.   
- [x] What steps can you take in your web apps to keep your data secure?
      Avoid using local storage to store sensitive information. Try to use tokens and secure authentication. 
- [x] Describe how web servers work.
      Web servers host the information, and pages served up to users on the World Wide Wed.  
- [x] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
      Get - receive , put - update , delete - delete,post - create.
